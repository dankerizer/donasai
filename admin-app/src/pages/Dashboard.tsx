	...
	return (
		<div className="space-y-8">
			...
			<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
				<div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
					<div className="flex items-center gap-4">
						...
						<div>
							<p className="text-sm font-medium text-gray-600 my-0!">Total Donasi</p>
				...
				<div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
					<div className="flex items-center gap-4">
						...
						<div>
							<p className="text-sm font-medium text-gray-600 my-0!">Total Donatur</p>
							<h3 className="text-2xl! font-bold text-gray-900 my-0!">
			...
			<div className="relative">
					...
					<div className="absolute inset-0 z-10 bg-white/60 backdrop-blur-sm flex flex-col items-center justify-center text-center p-6 rounded-xl border border-dashed border-gray-300">
						<div className="max-w-lg space-y-4">
							...
							<p className="text-gray-600 text-base! md:text-md!">
								...
								retensi donatur, dan performa kampanye secara real-time. 
								Ambil keputusan berbasis data untuk meningkatkan penggalangan dana Anda.
							</p>
							<div className="pt-2">
								<Link
									to="/settings"
				...
				<div className={clsx("space-y-8 transition-all", !isProActive && "blur-sm opacity-60 select-none")}>
					...
					<div>
						...
						<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
							...
							<div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
								...
								<h3 className="text-2xl font-bold text-gray-900">
									Rp {displayStats?.recurring_revenue?.toLocaleString("id-ID") || 0}
								</h3>
