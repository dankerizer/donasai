		...
		<div className="space-y-6">
			...
			{/* <div className="bg-linear-to-r from-emerald-50 to-teal-50 border border-emerald-100 rounded-xl p-4 flex items-center justify-between">
				...
				<button
					type="button"
					disabled
					className="px-4 py-2 bg-white text-gray-400 font-medium rounded-lg border border-gray-200 cursor-not-allowed text-sm"
				>
			...
			{selectedProof && (
				<div className="fixed inset-0 z-50 flex items-center justify-center p-4">
					<div
						...
						onClick={() => !updateStatus.isPending && setSelectedProof(null)}
						onKeyDown={(e) => {
							if (e.key === "Escape" || e.key === "Enter" || e.key === " ") {
								if (!updateStatus.isPending) setSelectedProof(null);
							}
						}}
						role="button"
						tabIndex={0}
