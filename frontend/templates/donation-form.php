...
<body <?php body_class('wpd-payment-page'); ?>>
                    ...
                    <?php if ($type === 'zakat'): ?>
                        ...
                        <div class="wpd-callout-blue ">
                            ...
                            <div class="wpd-form-row">
                                ...
                                <input type="number" id="zakat_calc_input" class="wpd-input mt-2"
                                    placeholder="Masukkan jumlah harta / penghasilan" oninput="calculateZakat()">
                            </div>
                        </div>
    ...
    <style>
        ...
        body.admin-bar .wpd-header-mobile {
            top: 32px;
        }
        ...
        input:checked+.slider {
            background-color: var(--wpd-primary, #2563eb);
        }
